...
class PopupDosenBuatPekerjaan extends StatefulWidget {
  const PopupDosenBuatPekerjaan({super.key});

  @override
  State<PopupDosenBuatPekerjaan> createState() => _PopupDosenBuatPekerjaanState();
}

class _PopupDosenBuatPekerjaanState extends State<PopupDosenBuatPekerjaan> {
  @override
