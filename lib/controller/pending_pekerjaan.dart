...
class KompetensiAdmin{
  ...
  factory KompetensiAdmin.fromJson(Map<String, dynamic> json){
    return KompetensiAdmin(kompetensiAdmin: json['kompetensi_admin_id'] ?? 0, kompetensiNama: json['kompetensi_nama'] ?? '');
  }
}
...
class Pekerjaan {
  ...
  factory Pekerjaan.fromJson(Map<String, dynamic> json){
    return Pekerjaan(pekerjaanID: json['pekerjaan_id'] ?? 0, userID: json['user_id'] ?? 0, pekerjaanNama: json['pekerjaan_nama'] ?? '');
  }
}
