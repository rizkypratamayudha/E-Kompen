class Pekerjaan {
  ...
  factory Pekerjaan.fromJson(Map<String, dynamic> json){
    return Pekerjaan(
      ...
      akumulasi_deadline: json['akumulasi_deadline'] ?? '',
      status: json['status'],
...
class User {
  ...
  final String nama;
  final String avatar;
  final DetailDosen detail_dosen;
  ...
  factory User.fromJson(Map<String, dynamic> json) {
    return User(
      ...
      nama: json['nama'] ?? '',
      avatar: json['avatar'] ?? '',
      detail_dosen: DetailDosen.fromJson(json['detail_dosen'])
    );
  }
}
...
class DetailDosen{
  ...
  factory DetailDosen.fromJson(Map<String, dynamic> json) {
    return DetailDosen(
      detail_dosen_id: json['detail_dosen_id'],
